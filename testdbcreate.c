...
int main(int argc, char *argv[])
{
    ...
    const char *paymentsData[] = {
        "1, 1, 100.00, '2024-01-01', '2024-01-10'",
        "2, 2, 200.00, '2024-01-02', '2024-01-12'",
        "3, 3, 150.00, '2024-02-01', '2024-02-10'",
        "4, 4, 250.00, '2024-02-02', '2024-02-15'",
        "5, 5, 300.00, '2024-03-01', '2024-03-10'",
        "6, 6, 350.00, '2024-03-02', '2024-03-12'",
        "7, 7, 400.00, '2024-04-01', '2024-04-10'",
        "8, 8, 450.00, '2024-04-02', '2024-04-15'",
        "9, 9, 500.00, '2024-05-01', '2024-05-10'",
        "10, 10, 550.00, '2024-05-02', '2024-05-12'"};
